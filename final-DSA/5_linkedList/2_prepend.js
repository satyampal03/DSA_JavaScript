...
class LinkedList{
    ...
    prepend(value){
        ...
        if(this.isEmpty()){
            this.head = node; // if there is nothing then head me node add kr do 
        }else{
            this.next = this.head; // next value me head ko add kr do
            this.head = node; // else head pr 1st value pr node ad kr do
        }
        this.size++
    }
