class Queue {
    constructor(capacity) {
        ...
        this.currentLength = 0; // Fixed spelling here (currentLengt -> currentLength)
        this.rear = -1;
        this.front = -1;
    }

    isFull() {
        // Parentheses needed to call the function
        return this.currentLength === this.capacity; // Used currentLength consistently
    }
    isEmpty() {
        // Parentheses needed to call the function
        return this.currentLength === 0; // Used currentLength consistently
    }
    // Removed duplicate isFull() definition
